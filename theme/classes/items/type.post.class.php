	...
	*/
	function __construct() {
		...
		$this->addToModel("classname", array(
			"type" => "string",
			"label" => "CSS Class",
		"hint_message" => "CSS class for custom styling. If you don't know what this is, just leave it blank."
		));
		...
		$this->addToModel("description", array(
			...
			"error_message" => "A short description without any words? How strange."
		));
